  ...
  return (
    <div className="flex items-center justify-center bg-surface px-6 py-10" onKeyDown={(event) => {
      ...
      <div className="w-full max-w-md">
        ...
        <h1 className="text-4xl font-bold text-text-primary">Investor Login</h1>
        ...
        <section className="mt-8 space-y-5">
          ...
          <section className = 'flex gap-3'>
            ...
            <Link href = '/investor/register' className = 'button secondary'>{t('public.login.join-now')}</Link>
          </section>
        </section>
      </div>
    </div>
