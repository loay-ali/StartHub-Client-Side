...
const initialPosts = [
  ...
  },
  {
    id: 4,
    author: "Sofia Chen",
    role: "Program Director @ CleanTech Accelerator",
    avatar: "SC",
    avatarBg: "linear-gradient(135deg, #10b981, #059669)",
    type: "AMA Session",
    typeBg: "rgba(16, 185, 129, 0.08)",
    typeColor: "#059669",
    content: "We're hosting a live AMA session on Zoom this Thursday at 5 PM GMT. We'll answer questions about funding limits, application deadlines, and technical pilot scope for our upcoming Clean Energy Cohort 5. See you there!",
    likes: 34,
    comments: 7,
    hasLiked: false,
  },
