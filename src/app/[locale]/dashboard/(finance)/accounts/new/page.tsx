    ...
    return (
        <div className="space-y-6 max-w-2xl mx-auto pb-12">
            ...
            <div className="flex items-center justify-between border-b border-border pb-4">
                <div>
                    <h1 className="text-3xl font-extrabold text-text-primary tracking-tight">New Account</h1>
                    <p className="text-sm text-text-secondary mt-1">Add a new accounting category to your Chart of Accounts.</p>
                </div>
                <button 
                    type="button"
