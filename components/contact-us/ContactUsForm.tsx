              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl py-3 pl-12 pr-4 outline-none transition ${errors.name
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl py-3 pl-12 pr-4 outline-none transition ${errors.email
                        ? "border border-red-500"
                        : "border border-border focus:border-primary"
                      }`}
                  />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className={`w-full rounded-xl py-3 pl-12 pr-4 outline-none transition ${errors.message
                        ? "border border-red-500"
                        : "border border-border focus:border-primary"
                      }`}
                  />
