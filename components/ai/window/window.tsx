...
export default function AIWindow({closeWindow}:{closeWindow:Function}) {
    return (<section className = "flex flex-col fixed w-[500px] h-[600px] bottom-20 right-5 bg-[linear-gradient(to_top_right,#10b0c0,#14b8a6)] rounded shadow flex flex-col">
